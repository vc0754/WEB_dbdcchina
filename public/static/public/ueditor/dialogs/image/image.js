    ...
    UploadImage.prototype = {
            ...
            uploader.on('uploadSuccess', function (file, ret) {
                ...
                try {
                    ...
                    if (json.state == 'SUCCESS') {
                        // _this.imageList.push(json); //按上传成功的顺序插入到编辑器中
                        _this.imageList[$file.index()] = json; //按原来图片的排序插入到编辑器中 00 2017010
        ...
        getInsertList: function () {
            ...
            for (i = 0; i < this.imageList.length; i++) {
                ...
                /* 源自于对line:(722或721)的修改，避免部分图片上传失败，
                或者选择的图片不符合规范不能参与上传而造成imageList数组中出现的undefined项 oo */
                if(data == undefined){
                    continue;
                }
                list.push({
